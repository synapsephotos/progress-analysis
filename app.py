...
upgrade_requirements = {
    'Welfare': [2000, 2500, 7500, 13000, 40000, 115000, 70000, 350000],  # Costs for L0->L1, L1->L2, ..., L7->L8
    'Coin Earning': [800, 700, 3000, 11500, 13000, 56000, 115000, 300000],
    'Luck': [4000, 11000, 35000, 130000, 220000, 500000, 600000, 1500000],
    'Size': [2000, 2500, 15500, 55000, 125000, 250000, 550000, 1000000]
}
